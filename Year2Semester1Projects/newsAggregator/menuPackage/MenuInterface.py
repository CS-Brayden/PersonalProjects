...
class MenuInterface:
    ...
    def UtiliseMenu(self):
        while True:
            ...
            ConsoleInterface.ReadValue("Press any button to continue: ")
    ...
    def _SelectOption(self, invalidOption = "Invalid option"):
        while True:
            selectedValue = ConsoleInterface.ReadRequiredValue(self.optionPrompt, self.options.keys(), invalidOption)
            try:
